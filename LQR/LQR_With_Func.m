...
Caf = 582000; % Cornering stiffnes az első kerékhez
Car = 783000; % Cornering stiffnes a hátsó kerékhez
lf = 1.95; % Az autó tömegközéppontjától mért elülső tengelytáv
lr = 1.54; % Az autó tömegközéppontjától mért hátsó tengelytáv
m = 2000; % Az autó tömege
Vx = 20; % Az autó haladási sebessége a saját koordinátarendszerében
Iz = 34917; % Az autó tehetetlenségi nyomatéka
% Vy = y', ay = y''
